...
public class ObjectFactory {
    ...
    private final static QName _GetTeamResponse_QNAME = new QName("http://server.ex3.g6.com/", "getTeamResponse");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://server.ex3.g6.com/", "getTeamsResponse");
    private final static QName _GetTeam_QNAME = new QName("http://server.ex3.g6.com/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://server.ex3.g6.com/", "getTeams");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex3.g6.com/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex3.g6.com/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex3.g6.com/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex3.g6.com/", name = "getTeams")
